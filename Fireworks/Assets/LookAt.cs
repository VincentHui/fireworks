...
public class LookAt : MonoBehaviour {
    ...
    {
        GameObject.Instantiate(_fireworks[Random.Range(0, _fireworks.Length)], new Vector3(hit.transform.position.x, 0, hit.transform.position.z), Quaternion.identity);
